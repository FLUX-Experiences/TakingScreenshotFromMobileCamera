...
/// </summary>
public class PhoneCameraRenderer : MonoBehaviour
{
    /// <summary>
    ...
    /// <summary>
    /// needs to be ortographic
    /// </summary>
    public Camera relatedOrtographicCamera;

    /// <summary>
    /// once camera inited it has width and height
    /// </summary>
    public UnityEvent OnCameraInitSuccessfully;
    ...
    {
        Debug.Log("OnInited "+ webCamTexture.width);
        ...
        {
            relatedOrtographicCamera.orthographicSize = (width * (float)Screen.height / (float)Screen.width) / 2;
        }
        else
        {
            relatedOrtographicCamera.orthographicSize = height / 2;
        }

        OnCameraInitSuccessfully.Invoke();
    }
    ...
    /// </summary>
    public void OnAdjustPixelsDirectionToggleValueChanged(bool value)
    {
        if (adjustPixelsDirection != value)
        {
            adjustPixelsDirection = value;
            Initialize();
        }
    }
